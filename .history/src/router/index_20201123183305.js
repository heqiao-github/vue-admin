...
export const constantRoutes = [
...

  {
    ...
    name: 'createCae',
    component: MainApp,
    redirect: '/createCase/baseInfo',
    children:[
      {
        path: 'baseInfo',
        name:'baseInfo',
        component: () => import('@/views/caseList/createCase/baseInfo')
      },
      {
        path: 'person',
        name:'person',
        component: () => import('@/views/caseList/createCase/personInfo')
      },
      {
        path: 'dataUpload',
        name:'dataUpload',
        component: () => import('@/views/caseList/createCase/dataUpload')
      },
    ]
  },

  {
    path: '/caseManage',
    component: Layout,
    redirect: '/caseManage/baseCaseInfo',//'/dashboard',
    meta:{title:'案件管理'},
    children: [
      {
...

  {
    ...
    children: [
      ...
      },
      {
        path: 'feedbackInput',
        name: 'feedbackInput',
        component: () => import('@/views/archive/feedbackInput'),
        meta: { title: '反馈录入' }
      }
    ]
  },
