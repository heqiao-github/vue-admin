...
import MainApp from '@/views/caseList/createCase/in'
...
export const constantRoutes = [
...

  {
    ...
    name: 'createCae',
    //redirect: 'baseInfo',
    component: ()=> import('@/views/caseList/createCase/index.vue'),
    children:[
      {
        path: 'baseInfo',
        name:'baseInfo',
        comments: () => import('@/views/caseList/createCase/baseInfo.vue')
