      ...
      <div class="main-app">
        ...
        <div>
          <el-steps :active="active" finish-status="success">
            <el-step title="步骤 1" description="基本案情录入"> </el-step>
            <el-step title="步骤 2" description="嫌疑人/关联人信息录入">
            </el-step>
            <el-step title="步骤 3" description="非调单资料上传"></el-step>
          </el-steps>
          <router-view></router-view>
          <el-button style="margin-top: 12px;" @click="goToList"
            >完成</el-button
          >
          <el-button  style="margin-top: 12px;" @click="prev"
            >上一步</el-button
          >
          <el-button v-if="active==" style="margin-top: 12px;" @click="next"
            >下一步</el-button
          >
    ...
    chooseRouter(active) {
      ...
      switch (this.active) {
        case 0:
          ...
          break;
        case 1:
          this.$router.push("/createCase/person");
          break;
        case 2:
          this.$router.push("/createCase/dataUpload");
          break;
        default:
          this.$router.push("/");
          break;
